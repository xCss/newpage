	...
	if (/MSIE (\d+\.\d+);/.test(navigator.userAgent)){
	  ...
	  if (ieversion>=9)
		if (typeof this.naturalWidth === "undefined" || this.naturalWidth === 0) {
		  this.src = "#" + ($(this).attr('width') || this.width || $(this).naturalWidth()) + "x" + (this.naturalHeight || $(this).attr('height') || $(this).height());
		}
	} else {
...
function initialize() {
  ...
  mapCanvas.each(function () {
	...
	var image = 'images/svg/map-marker.svg';
...
function loadScript() {
  ...
  script.src = 'http://www.google.cn/maps/api/js?v=3.exp&sensor=false&' +
    'callback=initialize';
